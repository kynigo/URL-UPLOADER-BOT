...
class Translation(object):
    ...
    START_TEXT = """<b>Please send me any direct download URL Link, i can upload to telegram as File/Video</b>
<b>/help for more details...</b>"""
    ...
    SET_CUSTOM_USERNAME_PASSWORD = """<b>👮‍♂ Powered By :</b> @slogan_98"""
    ...
    NOT_AUTH_USER_TEXT_FILE_SIZE = "Detected File Size: {}. Free Users can only upload: {}\nPlease /upgrade your subscription.</a>"
    ...
    CURENT_ABOUT_DETAILS = """<b> I said :</b> Fuck you 
<b>she replies :</b> <a href="https://www.python.org/">oh ya! 3.10.8</a>
"""

    HELP_USER = """  
➪ <b>First send a Url, what fuck u want .I Dont care u 👅</b>
"""
...
✉️ Language : <b>{}</b>
🛌 Status : <b>{}</b>
 more info : The user is a HIV infected person 🧪.
"""
    ...
    EXTRACT_ZIP_ERRS_OCCURED = "Sorry. Errors occurred while processing compressed file. Please check everything again twice, and if the issue persists</a>"
